...
func (_m *RoleUsecase) CreatedRole(createRole *rolemanagement.CreateRoleRequest) (adminmodels.Roles, error) {
...
func (_m *RoleUsecase) DeleteRole(createRole *rolemanagement.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) GetRole(createRole *rolemanagement.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) GetRoles(createRole *rolemanagement.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) UpdateRole(createRole *rolemanagement.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
