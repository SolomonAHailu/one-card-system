...
func (_m *RoleRepository) CreatedRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*repo.CreateRoleRequest) (adminmodels.Roles, error)); ok {
		return rf(createRole)
	}
	if rf, ok := ret.Get(0).(func(*repo.CreateRoleRequest) adminmodels.Roles); ok {
		r0 = rf(createRole)
	} else {
		r0 = ret.Get(0).(adminmodels.Roles)
	}

	if rf, ok := ret.Get(1).(func(*repo.CreateRoleRequest) error); ok {
		r1 = rf(createRole)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RoleRepository) DeleteRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleRepository) GetRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleRepository) GetRoles(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleRepository) UpdateRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
