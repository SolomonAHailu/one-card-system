...
func (_m *RoleUsecase) CreatedRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
...
func (_m *RoleUsecase) DeleteRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) GetRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) GetRoles(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
...
func (_m *RoleUsecase) UpdateRole(createRole *repo.CreateRoleRequest) (adminmodels.Roles, error) {
	ret := _m.Called(createRole)
